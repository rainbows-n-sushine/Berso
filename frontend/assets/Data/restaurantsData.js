const dummyRestaurantsData = [
  {
    ...
    about:
      "Your go-to place for quick and tasty meals delivered right to your doorstep.",
    food: [
      {
  ...
  },
  {
    ...
    about:
      "The home of delicious pizzas with a wide range of toppings and crust options.",
    food: [
      {
        category: "Pizza",
        meals: [
  ...
  },
  {
    ...
    about:
      "The home of flame-grilled burgers, crispy fries, and refreshing beverages.",
    food: [
      {
  ...
  },
  {
    ...
    profileImage:
      "https://images.bolt.eu/store/2023/2023-06-15/fed1517f-efca-472b-bd09-f996f74c4539.jpeg",
    about:
      "Experience the art of sushi with our premium selection of fresh and delicious rolls.",
    food: [
      {
  ...
  },
  {
    ...
    about:
      "Savor the flavors of Mexico with our authentic and delicious grilled dishes.",
    food: [
      {
        category: "Tacos",
        meals: [
